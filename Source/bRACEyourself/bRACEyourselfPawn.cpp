...
#include "bRACEyourselfWheelFront.h"
#include "bRACEyourselfWheelRear.h"
...
const FName AbRACEyourselfPawn::LookUpBinding("LookUp");
const FName AbRACEyourselfPawn::LookRightBinding("LookRight");
const FName AbRACEyourselfPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

PRAGMA_DISABLE_DEPRECATION_WARNINGS

AbRACEyourselfPawn::AbRACEyourselfPawn()
{
	// Car mesh
	...
	{
		VehicleMovement->WheelSetups[0].WheelClass = UbRACEyourselfWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[1].WheelClass = UbRACEyourselfWheelFront::StaticClass();
		...
		VehicleMovement->WheelSetups[2].WheelClass = UbRACEyourselfWheelRear::StaticClass();
		...
		VehicleMovement->WheelSetups[3].WheelClass = UbRACEyourselfWheelRear::StaticClass();
...
void AbRACEyourselfPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AbRACEyourselfPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AbRACEyourselfPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &AbRACEyourselfPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &AbRACEyourselfPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AbRACEyourselfPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AbRACEyourselfPawn::OnResetVR); 
}

void AbRACEyourselfPawn::MoveForward(float Val)
{
	if (Val >= 0)
	{
...
void AbRACEyourselfPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void AbRACEyourselfPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void AbRACEyourselfPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AbRACEyourselfPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AbRACEyourselfPawn::EnableIncarView(const bool bState)
{
...
void AbRACEyourselfPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void AbRACEyourselfPawn::BeginPlay()
{
	Super::BeginPlay();
...
void AbRACEyourselfPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void AbRACEyourselfPawn::UpdateHUDStrings()
{
...
void AbRACEyourselfPawn::SetupInCarHUD()
{
...
void AbRACEyourselfPawn::UpdatePhysicsMaterial()
{
